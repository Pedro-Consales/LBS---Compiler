 # LBS---Compiler
-LBS is a generic programming language that needed to be compiled for an assigment to a teacher of my graduation at university PUC-Rio. This is a LBS compiler I made using C.
